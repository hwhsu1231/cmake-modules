...
file(READ "${CMAKE_CURRENT_LIST_DIR}/json6/value_answer.json"  TEST_JSON6_VALUE_ANSWER_CNT)
set(TEST6_JSON_OBJECT         "${TEST6_JSON_OBJECT_CNT}")
set(TEST6_DOT_NOTATION        ".po")
set(TEST_JSON6_VALUE_RESULT)
set(TEST_JSON6_VALUE_ANSWER   "${TEST_JSON6_VALUE_ANSWER_CNT}")
get_json_value_by_dot_notation(
    ERROR_VARIABLE      TEST6_CALL_ERR
    IN_JSON_OBJECT      "${TEST6_JSON_OBJECT}"
    IN_DOT_NOTATION     "${TEST6_DOT_NOTATION}"
    OUT_JSON_VALUE      TEST_JSON6_VALUE_RESULT)
...
file(READ "${CMAKE_CURRENT_LIST_DIR}/json7/value_answer.json"  TEST_JSON7_VALUE_ANSWER_CNT)
set(TEST7_JSON_OBJECT         "${TEST7_JSON_OBJECT_CNT}")
set(TEST7_DOT_NOTATION        ".po.zh_TW")
set(TEST_JSON7_VALUE_RESULT)
set(TEST_JSON7_VALUE_ANSWER   "${TEST_JSON7_VALUE_ANSWER_CNT}")
get_json_value_by_dot_notation(
    ERROR_VARIABLE      TEST7_CALL_ERR
    IN_JSON_OBJECT      "${TEST7_JSON_OBJECT}"
    IN_DOT_NOTATION     "${TEST7_DOT_NOTATION}"
    OUT_JSON_VALUE      TEST_JSON7_VALUE_RESULT)
...
file(READ "${CMAKE_CURRENT_LIST_DIR}/json8/value_answer.json"  TEST_JSON8_VALUE_ANSWER_CNT)
set(TEST8_JSON_OBJECT         "${TEST8_JSON_OBJECT_CNT}")
set(TEST8_DOT_NOTATION        ".po.zh_TW.tag")
set(TEST_JSON8_VALUE_RESULT)
set(TEST_JSON8_VALUE_ANSWER   "${TEST_JSON8_VALUE_ANSWER_CNT}")
get_json_value_by_dot_notation(
    ERROR_VARIABLE    TEST8_CALL_ERR
    IN_JSON_OBJECT    "${TEST8_JSON_OBJECT}"
    IN_DOT_NOTATION   "${TEST8_DOT_NOTATION}"
    OUT_JSON_VALUE    TEST_JSON8_VALUE_RESULT)
set(TEST_JSON8_VALUE_RESULT "\"${TEST_JSON8_VALUE_RESULT}\"")
...
if(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/json9/object_result.json")
    file(REMOVE "${CMAKE_CURRENT_BINARY_DIR}/json9/object_result.json")
endif()
init_reference_json_file(
    IN_FILEPATH   "${CMAKE_CURRENT_BINARY_DIR}/json9/object_result.json"
    IN_LANGUAGES  "zh_CN;zh_TW"
    IN_TYPE       "branch"
    IN_VERSION    "master")
file(READ "${CMAKE_CURRENT_BINARY_DIR}/json9/object_result.json"  TEST_JSON9_OBJECT_RESULT)
file(READ "${CMAKE_CURRENT_LIST_DIR}/json9/object_answer.json"    TEST_JSON9_OBJECT_ANSWER)

# 
# TEST10: init a reference.json of tag type
# 

if(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/json10/object_result.json")
    file(REMOVE "${CMAKE_CURRENT_BINARY_DIR}/json10/object_result.json")
endif()
init_reference_json_file(
    IN_FILEPATH   "${CMAKE_CURRENT_BINARY_DIR}/json10/object_result.json"
    IN_LANGUAGES  "ja;zh_CN;zh_TW"
    IN_TYPE       "tag"
    IN_VERSION    "master")
file(READ "${CMAKE_CURRENT_BINARY_DIR}/json10/object_result.json" TEST_JSON10_OBJECT_RESULT)
file(READ "${CMAKE_CURRENT_LIST_DIR}/json10/object_answer.json"   TEST_JSON10_OBJECT_ANSWER)
...
string(JSON TEST_JSON6_EQUAL_OUT  ERROR_VARIABLE TEST_JSON6_EQUAL_ERR   EQUAL ${TEST_JSON6_VALUE_RESULT}    ${TEST_JSON6_VALUE_ANSWER})
string(JSON TEST_JSON7_EQUAL_OUT  ERROR_VARIABLE TEST_JSON7_EQUAL_ERR   EQUAL ${TEST_JSON7_VALUE_RESULT}    ${TEST_JSON7_VALUE_ANSWER})
string(JSON TEST_JSON8_EQUAL_OUT  ERROR_VARIABLE TEST_JSON8_EQUAL_ERR   EQUAL ${TEST_JSON8_VALUE_RESULT}    ${TEST_JSON8_VALUE_ANSWER})
string(JSON TEST_JSON9_EQUAL_OUT  ERROR_VARIABLE TEST_JSON9_EQUAL_ERR   EQUAL ${TEST_JSON9_OBJECT_RESULT}   ${TEST_JSON9_OBJECT_ANSWER})
string(JSON TEST_JSON10_EQUAL_OUT ERROR_VARIABLE TEST_JSON10_EQUAL_ERR  EQUAL ${TEST_JSON10_OBJECT_RESULT}  ${TEST_JSON10_OBJECT_ANSWER})
...
message(STATUS "TEST_JSON9_EQUAL_OUT  = ${TEST_JSON9_EQUAL_OUT}")
message(STATUS "TEST_JSON10_EQUAL_OUT = ${TEST_JSON10_EQUAL_OUT}")
...
# message(STATUS "TEST_JSON6_EQUAL_ERR = ${TEST_JSON6_EQUAL_ERR}")
# message(STATUS "TEST_JSON7_EQUAL_ERR = ${TEST_JSON7_EQUAL_ERR}")
# message(STATUS "TEST_JSON8_EQUAL_ERR = ${TEST_JSON8_EQUAL_ERR}")
...
if (TEST_JSON1_EQUAL_OUT  STREQUAL "ON" AND
    ...
    TEST_JSON8_EQUAL_OUT  STREQUAL "ON" AND
    TEST_JSON9_EQUAL_OUT  STREQUAL "ON" AND
    TEST_JSON10_EQUAL_OUT STREQUAL "ON")
else()
