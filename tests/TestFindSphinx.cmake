...
string(FIND "${Sphinx_AUTOGEN_EXECUTABLE}" "${Sphinx_ROOT_DIR}" FOUND_INDEX)
if(NOT FOUND_INDEX EQUAL -1)
    message(STATUS "Found ${Sphinx_ROOT_DIR} in ${Sphinx_AUTOGEN_EXECUTABLE}")
else()
    message(STATUS "${Sphinx_ROOT_DIR} not found in ${Sphinx_AUTOGEN_EXECUTABLE}")
endif()

string(FIND "${Sphinx_QUICKSTART_EXECUTABLE}" "${Sphinx_ROOT_DIR}" FOUND_INDEX)
if(NOT FOUND_INDEX EQUAL -1)
    message(STATUS "Found ${Sphinx_ROOT_DIR} in ${Sphinx_QUICKSTART_EXECUTABLE}")
else()
    message(STATUS "${Sphinx_ROOT_DIR} not found in ${Sphinx_QUICKSTART_EXECUTABLE}")
endif()
